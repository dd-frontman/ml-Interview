...
3. Язык документации — русский. Английский допустим только для:
   - синтаксиса и кода;
   - официальных названий технологий, библиотек, стандартов и терминов, которые нельзя корректно заменить без потери смысла.
4. Избегайте смешанных формулировок в одном предложении (например, `Data flow`, `threshold`), если есть точный русский эквивалент.
5. Перед коммитом запускайте:
